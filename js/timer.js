...
const startButton = document.querySelector(".timer-btn-block-start");
const stopButton = document.querySelector(".timer-btn-block-end");
const inputsTimer = document.querySelectorAll(".input-timer");
